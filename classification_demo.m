...
model_dir = 'C:\Users\isayk\Desktop\git\caffe-windows\models\bvlc_reference_caffenet\';
...
%fprintf(['using ' im ' as input image\n']);
%not path, actual image being passed so comment: im = imread(im);
...
d = load('C:\Users\isayk\Desktop\git\caffe-windows\matlab\+caffe\imagenet\ilsvrc_2012_mean.mat');
